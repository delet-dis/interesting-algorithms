...
class LabyrinthGeneratorRepository implements LabyrinthGeneratorInterface {
    ...
    private static findPossibleDirection(width: number, height: number, maze: LabyrinthCell[][], list: number[], i: number, j: number): number[] {
    ...
    public generateLabyrinth(width: number, height: number): LabyrinthCell[][] {
        ...
        list = LabyrinthGeneratorRepository.findPossibleDirection(width, height, Labyrinth, list, a, b)
